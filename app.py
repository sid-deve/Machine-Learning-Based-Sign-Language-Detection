...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        # print(frame.shape)
        frame=cv2.rectangle(frame,(0,40),(500,500),255,2)
        ...
        cv2.rectangle(frame, (0,0), (500, 40), (245, 117, 16), -1)
        cv2.putText(frame,"Output: -  "+''.join(sentence)+" "+''.join(accuracy), (3,30),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2, cv2.LINE_AA)
        # print(sentence)
        # Show to screen
